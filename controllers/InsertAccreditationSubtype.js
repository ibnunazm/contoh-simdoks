...
const insertAccreditationSubtypes = async () => {
  try {
    const existingAccreditationSubtypes = await AccreditationSubtypes.findAll();
    if (existingAccreditationSubtypes.length === 0) {
      ...
      await AccreditationSubtypes.bulkCreate(AccreditationSubtypesToInsert);
...
export default insertAccreditationSubtypes;
